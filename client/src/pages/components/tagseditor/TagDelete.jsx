    ...
    return (
        <div className="bg-zinc-700 text-zinc-100 font-ubuntu w-80">
            ...
            <div className="flex justify-around">
                ...
                <button onClick={() => deleteTags()} className="bg-red-900 px-6 py-2 text-xl text-zinc-400 rounded-md shadow-zinc-900 shadow-md hover:bg-red-800 hover:text-zinc-300 active:bg-zinc-600 active:text-zinc-100">Delete</button>
            </div>
        </div>
    )
}
