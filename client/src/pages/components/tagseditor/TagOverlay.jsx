...
export default function TagOverlay({ tags, selectedTag, handleSubmit }) {
    ...
    return (
        <div className="bg-zinc-700 text-zinc-100 font-ubuntu">
            <span className="text-2xl">{tags.at(selectedTag - 1).tag_visual} - Tag Editor</span>
            ...
            <div className="flex mt-5 justify-center">
                <button onClick={() => handleSubmit()} className="bg-zinc-400 px-6 py-2 text-xl text-zinc-700 rounded-md shadow-zinc-900 shadow-md hover:bg-zinc-500 hover:text-zinc-300 active:bg-zinc-600 active:text-zinc-100">Submit</button>
            </div>
        </div>
    )
}
